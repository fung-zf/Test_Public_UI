...
public class ClearWriteEditText extends android.support.v7.widget.AppCompatEditText implements View.OnFocusChangeListener , TextWatcher {
    ...
    /*状态变换接口回调*/
    private OnSetNullListener onSetNullListener;
    ...
    private void init() {
        mClearDrawable = getResources().getDrawable(R.drawable.vector_drawable_clear);
...
//                        && (event.getX() < ((getWidth() - getPaddingRight())));
                if (touchable) {
                    this.setText("");
                    if (onSetNullListener!=null){
                        onSetNullListener.hideKey();
                    }
                }
            }
        }
    ...
    public void setSetNullListener(@Nullable OnSetNullListener l) {
        this.onSetNullListener = l;
    }
