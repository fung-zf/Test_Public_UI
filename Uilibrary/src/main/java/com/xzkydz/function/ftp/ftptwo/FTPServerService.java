...
package com.xzkydz.function.ftp.ftptwo;
...
import com.xzkydz.function.ftp.ProxyConnector;
import com.xzkydz.function.ftp.SessionThread;
import com.xzkydz.function.ftp.TcpListener;
...
public class FTPServerService extends Service implements Runnable {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        while (serverThread != null) {
            ...
            if (attempts > 0) {
                attempts--;
                com.xzkydz.function.ftp.Util.sleepIgnoreInterupt(1000);
            } else {
    ...
    private void setupNotification() {
        ...
        builder.setTicker("报告传输");
        builder.setContentTitle("无线传输服务正在运行");
        builder.setContentText("请在\"我的电脑\"地址栏输入 "+contentText);
        ...
        while (!shouldExit) {
            if (acceptWifi) {
                ...
                if (wifiListener == null) {
                    ...
                    // crashed,
                    // so spawn it
                    wifiListener = new TcpListener(listenSocket, FTPServerService.this);
                    wifiListener.start();
                }
            }
            if (acceptNet) {
                ...
                if (proxyConnector == null) {
                    ...
                    if (shouldStartListener) {
                        ...
                        proxyConnector = new ProxyConnector(FTPServerService.this);
    ...
    public static InetAddress getWifiIp() {
        ...
        if (isWifiEnabled()) {
            ...
            if (ipAsInt == 0) {
                ...
                return   com.xzkydz.function.ftp.Util.intToInet(ipAsInt);
            }
        } else {
            return null;
        }
